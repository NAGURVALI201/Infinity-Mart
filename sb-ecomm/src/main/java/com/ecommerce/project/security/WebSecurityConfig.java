...
//        if we define in SecurityFilterChain spring security will check and permit all the request
...
//        if we define something WebSecurityCustomizer spring security won't even check the url

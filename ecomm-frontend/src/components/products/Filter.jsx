...
const Filter = ({ categories }) => {
  ...
  useEffect(() => {
    ...
    // we don't multiple hits to db when search if type something after another previous request will be cleared.
    return () => {

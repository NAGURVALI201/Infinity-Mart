    ...
    <div className="h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0">
      <div className="lg:p-14 sm:px-8 px-4 w-full flex justify-between">
        <Link to="/" className="flex items-center text-2xl font-bold">
          ...
          <span className="font-[Poppins]">Infinity Mart</span>
        </Link>

        <ul
          className={`flex sm:gap-10 gap-4 sm:items-center text-slate-800 sm:static absolute left-0 top-[70px] sm:shadow-md ${
        ...
        >
          ...
          {user && user.username ? (
            ...
            text-white font-semibold rounded-md shadow-lg duration-300 ease-in-out transform"
                to="/login"
              >
                <FaSignInAlt />
                <span>Login</span>
